...
import 'package:multirole/UI/dashboard_manager.dart';
import 'manager_register_page.dart';
...
class _ManagerLoginPageState extends State<ManagerLoginPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Login as Manager'),
      ),
    ...
    return Center(
      child: InkWell(
        ...
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => const ManagerRegisterPage()), // Ganti dengan halaman registrasi manager
          );
        },
      ),
    );
